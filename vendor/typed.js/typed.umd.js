!function(t, s) {
    ...
    return function() {
        ...
        s.doneTyping = function(t, s) {
            ...
            this.isFinalString() && (this.complete(),
            !1 === this.loop || this.curLoop === this.loopCount) || (this.timeout = this.shouldBackspace ? setTimeout(function() {
                e.backspace(t, s)
            }, this.backDelay) : setTimeout(function() {
                e.arrayPos++,
        ...
        s.backspace = function(t, s) {
            ...
            if (!0 !== this.pause.status) {
                ...
                this.timeout = setTimeout(function() {
                    ...
                    s > e.stopNum ? (s--,
                    e.backspace(t, s)) : s <= e.stopNum && (e.isFinalString() ? e.lastStringBackspaced() : (e.arrayPos++,
        ...
        s.lastStringBackspaced = function() {
            ...
            this.loop && (this.shuffleStringsIfNeeded(),
            this.begin())
        }
        ,
        s.complete = function() {
